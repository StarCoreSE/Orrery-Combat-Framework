...
namespace OrreryFramework.Communication
{
    ...
    public class ProjectileDefinitionBase
    {
        ...
        {
            HeartApi.ProjectileDefinitions.Add(this); // Register will need to be called manually if this is not in the HeartDefinitions class.
        }

        internal void Register()
        {
            HeartApi.DefinitionApi.RegisterDefinition(Name, this);
            HeartApi.DefinitionApi.RegisterDelegates<ProjectileDefinitionBase>(Name, (Dictionary<string, Delegate>) LiveMethods);
        }
