...
namespace Orrery.HeartModule.Server.Weapons
{
    ...
    internal class WeaponManager
    {
        ...
        private Dictionary<uint, SorterWeaponLogic> _weapons = new Dictionary<uint, SorterWeaponLogic>();
        private uint _highestWeaponId = 0;
        ...
        {
            SorterWeaponLogic logic = new SorterWeaponLogic(sorter, definition, _highestWeaponId++);
            _weapons.Add(logic.Id, logic);
        }

        internal static void RemoveWeapon(uint id)
        {
